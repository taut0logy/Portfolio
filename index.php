...
<html lang="en">
    ...
    <body>
        ...
        <section class="home" id="home">
            <div class="home-container container grid">
                <div class="home-content">
                    ...
                    <h1 class="home-title">
                        <span>I'm </span>Raufun Ahsan<br /><span class="typed"
                            >a developer</span
                    ...
                    <div class="home-btns">
                        <a class="btn" href="assets/cv.pdf" class="home-links"
                            >See my resume</a
                        >
                        <a
                ...
                <div class="about-content">
                    ...
                    <ul class="about-data grid">
                        ...
                        <li class="data-item">
                            ...
                            <a
                                href="mailto:raufun.ahsan@gmail.com"
                                class="data-desc about-link"
                                >raufun.ahsan@gmail.com</a
                            >
                        </li>
                    </ul>
                    <div class="about-bottom">
                        ...
                        <div class="about-links">
                            <a href="https://www.linkedin.com/in/raufun-ahsan/" class="about-link"
                                ><i class="fa-brands fa-linkedin fa-xl"></i
                            ></a>
                            <a href="https://github.com/taut0logy/" class="about-link"
                                ><i class="fa-brands fa-github fa-xl"></i
                            ></a>
                            <a href="https://www.facebook.com/raufun.ahsan" class="about-link"
                                ><i class="fa-brands fa-facebook fa-xl"></i
                            ></a>
                            <a href="https://www.instagram.com/raufun_ahsan" class="about-link"
        ...
        <section class="qualifications section" id="qualifications">
            <h2
                class="section-title title-center underline"
        ...
        <section class="skills section" id="skills">
            ...
            ?>
                ...
                <!-- <div class="skills-item">
                    ...
                    <p class="skills-desc">I have been coding in C for 3 years. I have developed various console applications using C. and honed my algorithmic skills in Competitive programming.</p>
                    <div class="skills-bar">
                        <div class="skills-percentage" style="width: 85%;"><span></span></div>
                    </div>
                </div>
                ...
                <div class="skills-item">
                    ...
                    <p class="skills-desc">Besdes developing console applications, I have developed various games using C++ and honed my algorithmic skills in Competitive programming.</p>
                    <div class="skills-bar">
                ...
                <!-- <div class="skills-item">
                    ...
                    <p class="skills-desc">I have built desktop and mobile applications using Java. I have learned JaaFX, Swing ang other libraries.</p>
                    <div class="skills-bar">
                        <div class="skills-percentage" style="width: 80%;"><span></span></div>
                    </div>
                </div> -->
                ...
                <!-- <div class="skills-item">
                    ...
                    <p class="skills-desc">I have been learnig Kotlin and building android apps with it for 2 years. I have developed an Android game using Kotlin.</p>
                    <div class="skills-bar">
        ...
        <footer class="footer">
            <div class="footer-container container">
                ...
                <div class="footer-links">
                    <a href="https://www.linkedin.com/in/raufun-ahsan/" class="footer-link"
                        ><i class="fa-brands fa-linkedin fa-xl"></i
                    ></a>
                    <a href="https://github.com/taut0logy" class="footer-link"
                        ><i class="fa-brands fa-github fa-xl"></i
                    ></a>
                    <a href="https://www.facebook.com/raufun.ahsan" class="footer-link"
                        ><i class="fa-brands fa-facebook fa-xl"></i
                    ></a>
                    <a href="https://www.instagram.com/raufun_ahsan" class="footer-link"
                        ><i class="fa-brands fa-instagram fa-xl"></i
                    ></a>
                </div>
